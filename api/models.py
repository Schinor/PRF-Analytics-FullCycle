...
class Acidentes_Registrados(Base):
    ...
    tipo_acidente: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    condicao_metereologica: Mapped[Optional[str]] = mapped_column(String(120))
    tipo_pista: Mapped[Optional[str]] = mapped_column(String(120))
    tracado_via: Mapped[Optional[str]] = mapped_column(String(120))
